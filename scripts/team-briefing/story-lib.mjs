...
export function buildStoryPrompt(payload, issueNo) {
  ...
  const featureLine =
    (payload.featureIntros ?? []).length === 0
      ? "없음"
...
팀 컨텍스트:
- 우리 팀(운영부)의 주 업무는 대학 입시 인터넷 원서접수 운영과 합격자통합관리시스템(PIMS) 운영이며, 수반 업무도 함께 진행합니다.
- 연간 주기: 매년 3월 시작 ~ 차년도 2월 종료. 피크는 9월(수시)과 12~1월(정시)이며, 12~2월엔 합격자통합관리(PIMS) 운영이 동반됩니다. 그 외 기간엔 대학원·초중고·외국인/재외국민/기타 원서접수 운영을 진행합니다. 지금이 어느 국면인지(피크 준비·피크·비수기 등)를 이야기에 자연스럽게 반영하세요.
- 운영부 달력에는 근무·원서접수·PIMS·외부회의·교육·휴가 일정이 올라옵니다 — 사내 교육 일정도 팀 업무 맥락으로 자연스럽게 다뤄주세요.
- 독자는 신입부터 장기 근속자까지 다양한 연차의 운영부 동료 전원입니다. 쉬운 표현, 존댓말.
...
- features: 아래 '이번 주 기능 소개' 항목들을 왜 지금 알아두면 좋은지 운영 맥락으로 엮는 2~3문장. 기능 이름을 나열만 하지 말고 어떤 상황에서 쓰는지 한 컷으로 그려주세요. 항목이 '없음'이면 빈 문자열("")로 두세요.
