...
/**
 * 한참 지났는데도 아무도 안 가져간 상태.
 *
 * 예전엔 "회사 PC가 응답하지 않습니다 … 빠른 답변 모드로 물어보세요"라고 했다.
 * 빠른 답변(Gemini)을 걷어내 갈 곳이 없어졌고, 무엇보다 **꺼진 건지 느린 건지
 * 화면은 모른다** — 단정하지 않는 말투가 사실에도 맞다. 실제로 claim 이 27초
 * 걸린 적이 있다(2026-08-19).
 */
export const STAGE_STILL_QUEUED =
  "에이전트를 계속 부르는 중 — 아직 응답이 없는 것 같아요";
