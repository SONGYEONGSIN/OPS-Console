  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        count: "4",
        items: [
          { ico: "·", label: "인사이트", count: "12", slug: "ai-insight", pattern: "dash" },
          { ico: "·", label: "어시스턴트", slug: "ai-assistant", pattern: "settings" },
          { ico: "·", label: "내 작업", count: "5", slug: "my-ai-work", pattern: "list" },
          { ico: "·", label: "TIP 공유", count: "8", slug: "ai-tips", pattern: "list" },
        ],
      },
    ],
  },
