...
export function InsightInspectorBody({ video, canDelete, onDeleted }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="aspect-video w-full overflow-hidden bg-washi">
        <iframe
      ...
      <a
        ...
        className="inline-flex items-center justify-center border border-vermilion bg-vermilion px-3 py-2 text-sm font-medium text-cream transition-opacity hover:opacity-90"
      >
        YouTube에서 열기 →
      </a>
