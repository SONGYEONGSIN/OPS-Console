...
export function SearchBox() {
  ...
  return (
    <div ref={wrapRef} className="relative w-full">
      <div className="flex w-full min-w-[240px] items-center gap-1.5 border border-line-soft bg-search-field-bg px-3 py-2 transition-colors focus-within:border-2 focus-within:border-ink focus-within:bg-white">
