...
export function SearchBox() {
  ...
  return (
    <div ref={wrapRef} className="relative w-full">
      <div className="flex w-full min-w-[240px] items-center gap-1.5 border border-line-soft bg-washi px-2.5 py-1 transition-colors focus-within:border-ink focus-within:bg-white">
