    ...
    <div className="border border-line-soft bg-white p-2.5">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          onClick={onRemove}
          className="inline-flex h-5 w-5 shrink-0 cursor-pointer items-center justify-center border border-line bg-paper text-base leading-none text-ink-soft transition-colors hover:border-ink hover:bg-ink hover:text-cream"
        >
          ×
        </button>
      </div>
      ...
      {showSubstituteSelect && (
        <div className="mt-2">
          ...
          <select
            ...
            className="w-full border border-line-soft bg-field-bg transition-colors focus:border-ink focus:bg-white px-2 py-1 text-xs text-ink"
          >
