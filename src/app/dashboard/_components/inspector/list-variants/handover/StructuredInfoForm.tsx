      ...
      <label className="flex items-start gap-2">
        ...
        {readOnly ? (
          ...
          <textarea
            ...
            className="field-sizing-content min-h-16 flex-1 border border-line-soft bg-field-bg px-2 py-1 text-ink transition-colors focus:border-ink focus:bg-white"
          />
        )}
      </label>
    </div>
