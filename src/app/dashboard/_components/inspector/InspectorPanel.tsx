...
export function InspectorPanel({ open, onClose, children }: Props) {
  ...
  return (
    <aside
      ...
      role="complementary"
      aria-hidden={!open}
      className={`fixed right-0 top-[82px] bottom-6 z-40 w-full bg-washi-raised border-l border-line transition-transform duration-[var(--drawer-ms)] ease-[var(--drawer-ease)] [box-shadow:var(--shadow-drawer-right)] md:top-[86px] md:bottom-[26px] md:w-[320px] ${
