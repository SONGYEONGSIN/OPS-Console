    ...
    <section className="space-y-5 p-7">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <MineScopeToggle mineLabel="내 업무" allLabel="전체 업무" />
        </div>
      </header>
                ...
                <ul className="space-y-0.5">
                  ...
                  {visibleSvcs.map((sb, idx) => (
                    <li
                      ...
                      className="flex cursor-grab items-center gap-1 truncate text-2xs font-medium text-ink active:cursor-grabbing"
